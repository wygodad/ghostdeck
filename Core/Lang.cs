...
public static class Lang
{
    ...
    private static readonly Dictionary<string, string[]> Map = new()
    {
        ...
        ["log_curve_restore"] = new[] { "Fan curve restored: {0}", "Przywrócono krzywą: {0}", "Lüfterkurve wiederhergestellt: {0}", "Courbe restaurée : {0}", "Curva restaurada: {0}", "已恢复风扇曲线：{0}", "Curva restaurada: {0}", "Кривая восстановлена: {0}" },
        ["fc_custom"]      = new[] { "custom curve", "własna krzywa", "eigene Kurve", "courbe personnalisée", "curva personalizada", "自定义曲线", "curva personalizada", "своя кривая" },
        ["set_grp_diag"]   = new[] { "Diagnostics", "Diagnostyka", "Diagnose", "Diagnostic", "Diagnóstico", "诊断", "Diagnóstico", "Диагностика" },
        ["diag_save"]      = new[] { "Save diagnostic package…", "Zapisz pakiet diagnostyczny…", "Diagnosepaket speichern…", "Enregistrer le paquet de diagnostic…", "Guardar paquete de diagnóstico…", "保存诊断包…", "Salvar pacote de diagnóstico…", "Сохранить пакет диагностики…" },
        ["set_grp_batt"]   = new[] { "Battery health", "Zdrowie baterii", "Akkuzustand", "Santé de la batterie", "Salud de la batería", "电池健康", "Saúde da bateria", "Состояние батареи" },
        ["bh_design"]      = new[] { "Design capacity", "Pojemność projektowa", "Nennkapazität", "Capacité nominale", "Capacidad de diseño", "设计容量", "Capacidade de projeto", "Проектная ёмкость" },
        ["bh_full"]        = new[] { "Full-charge capacity", "Pojemność po pełnym ładowaniu", "Aktuelle Vollladekapazität", "Capacité à pleine charge", "Capacidad a plena carga", "满充容量", "Capacidade em carga plena", "Ёмкость при полном заряде" },
        ["bh_wear"]        = new[] { "Wear", "Zużycie", "Verschleiß", "Usure", "Desgaste", "损耗", "Desgaste", "Износ" },
        ["bh_cycles"]      = new[] { "Charge cycles", "Cykle ładowania", "Ladezyklen", "Cycles de charge", "Ciclos de carga", "充电循环", "Ciclos de carga", "Циклы зарядки" },
        ["ov_m_ssd"]       = new[] { "SSD temp", "Temp. SSD", "SSD-Temp.", "Temp. SSD", "Temp. SSD", "SSD 温度", "Temp. SSD", "Темп. SSD" },
        ["ov_m_batttime"]  = new[] { "Battery time left", "Pozostały czas baterii", "Restlaufzeit", "Autonomie restante", "Tiempo de batería restante", "剩余电池时间", "Tempo restante de bateria", "Оставшееся время батареи" },
        ["st_left"]        = new[] { "Left", "Pozostało", "Verbleibt", "Restant", "Restante", "剩余", "Restante", "Осталось" },
        ["tier_telemetry"] = new[] { "temperatures only", "tylko temperatury", "nur Temperaturen", "températures seules", "solo temperaturas", "仅温度", "somente temperaturas", "только температуры" },
        ["set_fb_timer"]   = new[] { "Turn Fan Boost off automatically after", "Wyłączaj Fan Boost automatycznie po", "Fan Boost automatisch ausschalten nach", "Désactiver Fan Boost automatiquement après", "Desactivar Fan Boost automáticamente tras", "自动关闭 Fan Boost 的时间", "Desligar o Fan Boost automaticamente após", "Автовыключение Fan Boost через" },
        ["fb_never"]       = new[] { "Never", "Nigdy", "Nie", "Jamais", "Nunca", "从不", "Nunca", "Никогда" },
        ["fb_custom"]      = new[] { "Custom…", "Własna…", "Eigene…", "Personnalisé…", "Personalizado…", "自定义…", "Personalizado…", "Своё…" },
        ["fb_custom_ask"]  = new[] { "Fan Boost auto-off after how many minutes? (1-120)", "Po ilu minutach wyłączyć Fan Boost? (1-120)", "Fan Boost nach wie vielen Minuten ausschalten? (1-120)", "Désactiver Fan Boost après combien de minutes ? (1-120)", "¿Tras cuántos minutos desactivar Fan Boost? (1-120)", "多少分钟后自动关闭 Fan Boost？（1-120）", "Desligar o Fan Boost após quantos minutos? (1-120)", "Через сколько минут выключить Fan Boost? (1-120)" },
        ["fb_auto_off"]    = new[] { "Timer elapsed - back to the profile's fans", "Minął czas - wentylatory wracają do profilu", "Zeit abgelaufen - zurück zu den Profil-Lüftern", "Minuteur écoulé - retour aux ventilateurs du profil", "Tiempo cumplido - vuelta a los ventiladores del perfil", "计时结束 - 风扇回到配置文件设置", "Tempo esgotado - ventoinhas voltam ao perfil", "Время истекло - вентиляторы возвращаются к профилю" },
        ["fb_secs"]        = new[] { "{0} s", "{0} s", "{0} s", "{0} s", "{0} s", "{0} 秒", "{0} s", "{0} с" },
        ["fb_mins"]        = new[] { "{0} min", "{0} min", "{0} Min.", "{0} min", "{0} min", "{0} 分钟", "{0} min", "{0} мин" },
        ["telemetry_note"] = new[] {
        ...
        ["upd_retry"]      = new[] { "Try again", "Spróbuj ponownie", "Erneut versuchen", "Réessayer", "Reintentar", "重试", "Tentar novamente", "Повторить" },
        ["upd_downloads"]  = new[] { "Downloads: {0}", "Pobrania: {0}", "Downloads: {0}", "Téléchargements : {0}", "Descargas: {0}", "下载次数：{0}", "Downloads: {0}", "Загрузки: {0}" },
        ...
        ["set_app_icon"]   = new[] { "Application icon", "Ikona aplikacji", "App-Symbol", "Icône de l'application", "Icono de la aplicación", "应用图标", "Ícone do aplicativo", "Значок приложения" },
        ["icon_logo"]      = new[] { "GhostDeck logo", "Logotyp GhostDeck", "GhostDeck-Logo", "Logo GhostDeck", "Logotipo GhostDeck", "GhostDeck 标志", "Logotipo GhostDeck", "Логотип GhostDeck" },
        ...
        ["scen_active"]    = new[] { "ACTIVE", "AKTYWNY", "AKTIV", "ACTIF", "ACTIVO", "当前", "ATIVO", "АКТИВЕН" },
        ["scen_select"]    = new[] { "SELECT", "WYBIERZ", "WÄHLEN", "CHOISIR", "ELEGIR", "选择", "SELECIONAR", "ВЫБРАТЬ" },
        ["rep_restart"]    = new[] { "Start over", "Zacznij od nowa", "Neu beginnen", "Recommencer", "Empezar de nuevo", "重新开始", "Recomeçar", "Начать заново" },
        ["set_grp_ui"]     = new[] { "Interface", "Interfejs", "Oberfläche", "Interface", "Interfaz", "界面", "Interface", "Интерфейс" },
        ["set_grid"]       = new[] { "Background grid", "Siatka w tle", "Hintergrundraster", "Grille d'arrière-plan", "Cuadrícula de fondo", "背景网格", "Grade de fundo", "Фоновая сетка" },
        ["set_tab_as_icon"] = new[] { "{0} — as an icon on the right", "{0} - jako ikona po prawej", "{0} — als Symbol rechts", "{0} — en icône à droite", "{0} — como icono a la derecha", "{0} — 显示为右侧图标", "{0} — como ícone à direita", "{0} — значком справа" },
        ...
        // ---- Models tab ----
        ["tab_models"]     = new[] { "Models", "Modele", "Modelle", "Modèles", "Modelos", "机型", "Modelos", "Модели" },
        ["mdl_intro"]      = new[] {
        ...
        ["mdl_you"]        = new[] { "Your model", "Twój model", "Dein Modell", "Votre modèle", "Tu modelo", "你的机型", "Seu modelo", "Ваша модель" },
        ["mdl_unknown"]    = new[] { "Firmware {0} not recognised — read-only mode.", "Firmware {0} nierozpoznany — tryb tylko do odczytu.", "Firmware {0} nicht erkannt — Nur-Lese-Modus.", "Firmware {0} non reconnu — mode lecture seule.", "Firmware {0} no reconocido — modo de solo lectura.", "未识别固件 {0} — 只读模式。", "Firmware {0} não reconhecido — modo somente leitura.", "Прошивка {0} не распознана — режим только чтения." },
        ["mdl_c_family"]   = new[] { "Family", "Rodzina", "Familie", "Famille", "Familia", "家族", "Família", "Семейство" },
        ["mdl_c_status"]   = new[] { "Status", "Status", "Status", "Statut", "Estado", "状态", "Status", "Статус" },
        ["mdl_c_curve"]    = new[] { "Fan curve", "Krzywa", "Lüfterkurve", "Courbe", "Curva", "风扇曲线", "Curva", "Кривая" },
        ["mdl_c_sb"]       = new[] { "SB", "SB", "SB", "SB", "SB", "SB", "SB", "SB" },
        ["mdl_c_rpm"]      = new[] { "RPM", "RPM", "RPM", "RPM", "RPM", "RPM", "RPM", "RPM" },
        ["mdl_curve_edit"] = new[] { "editable", "edytowalna", "editierbar", "modifiable", "editable", "可编辑", "editável", "редактируемая" },
        ["mdl_curve_prev"] = new[] { "unverified", "niezweryfikowany", "unbestätigt", "non vérifiée", "sin verificar", "未验证", "não verificada", "не проверена" },
        ["mdl_sb_tip"]     = new[] {
        ...
        ["mdl_search"]     = new[] { "Search model or firmware…", "Szukaj modelu lub firmware…", "Modell oder Firmware suchen…", "Rechercher un modèle ou firmware…", "Buscar modelo o firmware…", "搜索机型或固件…", "Pesquisar modelo ou firmware…", "Поиск модели или прошивки…" },
        ["mdl_legend"]     = new[] {
        ...
        ["set_tray_left"]  = new[] { "Left click", "Lewy przycisk", "Linksklick", "Clic gauche", "Clic izquierdo", "左键单击", "Clique esquerdo", "Левый клик" },
        ["set_tray_mid"]   = new[] { "Middle click", "Środkowy przycisk", "Mittelklick", "Clic du milieu", "Clic central", "中键单击", "Clique do meio", "Средний клик" },
        ["set_tray_wheel"] = new[] { "Scroll wheel", "Kółko myszy", "Mausrad", "Molette", "Rueda del ratón", "滚轮", "Roda do mouse", "Колесо мыши" },
        ["act_none"]       = new[] { "Do nothing", "Nic nie rób", "Nichts tun", "Ne rien faire", "No hacer nada", "不执行操作", "Não fazer nada", "Ничего не делать" },
        ["act_show_state"] = new[] { "Show current state", "Pokaż bieżący stan", "Aktuellen Status anzeigen", "Afficher l'état actuel", "Mostrar estado actual", "显示当前状态", "Mostrar estado atual", "Показать текущее состояние" },
        ["act_open"]       = new[] { "Open: {0}", "Otwórz: {0}", "Öffnen: {0}", "Ouvrir : {0}", "Abrir: {0}", "打开：{0}", "Abrir: {0}", "Открыть: {0}" },
        ["twa_profiles"]   = new[] { "Switch profiles", "Przełączaj profile", "Profile wechseln", "Changer de profil", "Cambiar perfiles", "切换情景模式", "Alternar perfis", "Переключение профилей" },
        // (#26) keyboard backlight
        ["kbd_title"]      = new[] { "Keyboard backlight", "Podświetlenie klawiatury", "Tastaturbeleuchtung", "Rétroéclairage du clavier", "Retroiluminación del teclado", "键盘背光", "Retroiluminação do teclado", "Подсветка клавиатуры" },
        ["kbd_off"]        = new[] { "Off", "Wył.", "Aus", "Éteint", "Apagado", "关闭", "Desligado", "Выкл." },
        ...
        ["bri_title"]      = new[] { "Screen brightness", "Jasność ekranu", "Bildschirmhelligkeit", "Luminosité de l'écran", "Brillo de pantalla", "屏幕亮度", "Brilho da tela", "Яркость экрана" },
        // scene schedule
        ["sch_grp"]        = new[] { "Scene schedule", "Harmonogram scen", "Szenen-Zeitplan", "Planification des scènes", "Programación de escenas", "场景计划", "Agendamento de cenas", "Расписание сцен" },
        ["sch_enable"]     = new[] { "Schedule active", "Harmonogram aktywny", "Zeitplan aktiv", "Planification active", "Programación activa", "计划已启用", "Agendamento ativo", "Расписание включено" },
        ["sch_desc"]       = new[]
        {
        ...
        ["sch_add"]        = new[] { "Add rule", "Dodaj regułę", "Regel hinzufügen", "Ajouter une règle", "Añadir regla", "添加规则", "Adicionar regra", "Добавить правило" },
        ["sch_need_scene"] = new[]
        {
        ...
        ["sch_rule_title"] = new[] { "Schedule rule", "Reguła harmonogramu", "Zeitplan-Regel", "Règle de planification", "Regla de programación", "计划规则", "Regra de agendamento", "Правило расписания" },
        ["sch_scene"]      = new[] { "Scene", "Scena", "Szene", "Scène", "Escena", "场景", "Cena", "Сцена" },
        ["sch_days"]       = new[] { "Days", "Dni", "Tage", "Jours", "Días", "星期", "Dias", "Дни" },
        ["sch_from"]       = new[] { "From", "Od", "Von", "De", "Desde", "从", "De", "С" },
        ["sch_to"]         = new[] { "to", "do", "bis", "à", "hasta", "到", "até", "до" },
        ["sch_daily"]      = new[] { "Every day", "Codziennie", "Täglich", "Tous les jours", "Todos los días", "每天", "Todos os dias", "Ежедневно" },
        ["sch_weekdays"]   = new[] { "Weekdays", "Dni robocze", "Werktags", "Jours ouvrés", "Días laborables", "工作日", "Dias úteis", "Будни" },
        ["sch_weekend"]    = new[] { "Weekend", "Weekend", "Wochenende", "Week-end", "Fin de semana", "周末", "Fim de semana", "Выходные" },
        ["scen_gear_tip"]  = new[] { "Choose what this tab shows", "Wybierz, co pokazuje ta zakładka", "Wähle, was dieser Tab zeigt", "Choisissez ce que cet onglet affiche", "Elige qué muestra esta pestaña", "选择此选项卡显示的内容", "Escolha o que esta guia mostra", "Выберите, что показывает эта вкладка" },
        ["log_schedule"]   = new[] { "Schedule: {0} ({1}-{2})", "Harmonogram: {0} ({1}-{2})", "Zeitplan: {0} ({1}-{2})", "Planification : {0} ({1}-{2})", "Programación: {0} ({1}-{2})", "计划：{0}（{1}-{2}）", "Agendamento: {0} ({1}-{2})", "Расписание: {0} ({1}-{2})" },
        ["log_src_schedule"] = new[] { "schedule", "harmonogram", "Zeitplan", "planification", "programación", "计划", "agendamento", "расписание" },
        // touchpad (devnode switch)
        ["tp_title"]       = new[] { "Touchpad", "Touchpad", "Touchpad", "Pavé tactile", "Panel táctil", "触摸板", "Touchpad", "Тачпад" },
        ["tp_hint"]        = new[]
        {
        ...
        // battery-level rules
        ["bat_rules_grp"]  = new[] { "Battery rules", "Reguły baterii", "Akku-Regeln", "Règles de batterie", "Reglas de batería", "电量规则", "Regras de bateria", "Правила батареи" },
        ["bat_rules_desc"] = new[]
        {
        ...
        ["bat_enable"]     = new[] { "Rules active", "Reguły aktywne", "Regeln aktiv", "Règles actives", "Reglas activas", "规则已启用", "Regras ativas", "Правила включены" },
        ["bat_below"]      = new[] { "Below", "Poniżej", "Unter", "Sous", "Por debajo", "低于", "Abaixo", "Ниже" },
        ["bat_above"]      = new[] { "Above", "Powyżej", "Über", "Au-dessus", "Por encima", "高于", "Acima", "Выше" },
        ["log_batt_low"]   = new[] { "Battery {0} % - crossed below {1} %", "Bateria {0} % - spadła poniżej {1} %", "Akku {0} % - unter {1} % gefallen", "Batterie {0} % - passée sous {1} %", "Batería {0} % - cayó por debajo de {1} %", "电量 {0}% - 低于 {1}%", "Bateria {0} % - caiu abaixo de {1} %", "Батарея {0} % - опустилась ниже {1} %" },
        ["log_batt_high"]  = new[] { "Battery {0} % - crossed above {1} %", "Bateria {0} % - wzrosła powyżej {1} %", "Akku {0} % - über {1} % gestiegen", "Batterie {0} % - passée au-dessus de {1} %", "Batería {0} % - superó el {1} %", "电量 {0}% - 高于 {1}%", "Bateria {0} % - subiu acima de {1} %", "Батарея {0} % - поднялась выше {1} %" },
        ["log_src_battery"] = new[] { "battery", "bateria", "Akku", "batterie", "batería", "电量", "bateria", "батарея" },
        // Fn/Win swap (EC fn_win_swap)
        ["fnswap_grp"]     = new[] { "Keyboard layout", "Układ klawiatury", "Tastaturlayout", "Disposition du clavier", "Distribución del teclado", "键盘布局", "Layout do teclado", "Раскладка клавиатуры" },
        ["fnswap_title"]   = new[] { "Fn / Win keys", "Klawisze Fn / Win", "Fn/Win-Tasten", "Touches Fn / Win", "Teclas Fn / Win", "Fn / Win 键", "Teclas Fn / Win", "Клавиши Fn / Win" },
        ["fnswap_left"]    = new[] { "Fn on the left", "Fn po lewej", "Fn links", "Fn à gauche", "Fn a la izquierda", "Fn 在左", "Fn à esquerda", "Fn слева" },
        ["fnswap_right"]   = new[] { "Fn on the right", "Fn po prawej", "Fn rechts", "Fn à droite", "Fn a la derecha", "Fn 在右", "Fn à direita", "Fn справа" },
        ["fnswap_desc"]    = new[]
        {
        ...
        ["webcam_title"]   = new[] { "Webcam", "Kamera", "Webcam", "Webcam", "Cámara web", "摄像头", "Webcam", "Веб-камера" },
        ["webcam_hint"]    = new[] { "Hardware switch: the camera drops off USB (same as the Fn key)", "Sprzętowy przełącznik: kamera znika z USB (jak klawisz Fn)", "Hardware-Schalter: Kamera verschwindet vom USB (wie die Fn-Taste)", "Interrupteur matériel : la caméra disparaît de l'USB (comme la touche Fn)", "Interruptor de hardware: la cámara desaparece del USB (como la tecla Fn)", "硬件开关：摄像头从 USB 断开（与 Fn 键相同）", "Interruptor de hardware: a câmera some do USB (como a tecla Fn)", "Аппаратный переключатель: камера исчезает с USB (как клавиша Fn)" },
        ["set_grp_privacy"]= new[] { "Privacy", "Prywatność", "Datenschutz", "Confidentialité", "Privacidad", "隐私", "Privacidade", "Приватность" },
        ["webcam_block"]   = new[] { "Hard camera block", "Twarda blokada kamery", "Harte Kamerasperre", "Blocage matériel de la caméra", "Bloqueo duro de la cámara", "硬件级摄像头锁定", "Bloqueio rígido da câmera", "Жёсткая блокировка камеры" },
        ["webcam_block_desc"] = new[]
        {
        ...
        ["webcam_blocked"] = new[] { "Block active", "Blokada aktywna", "Sperre aktiv", "Blocage actif", "Bloqueo activo", "锁定已启用", "Bloqueio ativo", "Блокировка активна" },
        ["webcam_unblocked"] = new[] { "Block lifted", "Blokada zdjęta", "Sperre aufgehoben", "Blocage levé", "Bloqueo quitado", "锁定已解除", "Bloqueio removido", "Блокировка снята" },
        ["webcam_blocked_warn"] = new[] { "Camera is hard-blocked - lift the block in Settings → System", "Kamera jest twardo zablokowana - zdejmij blokadę w Ustawienia → System", "Kamera ist hart gesperrt - Sperre unter Einstellungen → System aufheben", "Caméra bloquée matériellement - levez le blocage dans Paramètres → Système", "La cámara está bloqueada - quita el bloqueo en Ajustes → Sistema", "摄像头已被硬件锁定 - 请在设置 → 系统中解除锁定", "A câmera está bloqueada - remova o bloqueio em Configurações → Sistema", "Камера жёстко заблокирована - снимите блокировку в Настройки → Система" },
        // (#21) scenes
        ["scene_title"]    = new[] { "Scenes", "Sceny", "Szenen", "Scènes", "Escenas", "自定义场景", "Cenas", "Сцены" },
        ["scene_applied"]  = new[] { "Scene applied", "Scena zastosowana", "Szene angewendet", "Scène appliquée", "Escena aplicada", "场景已应用", "Cena aplicada", "Сцена применена" },
        ["log_scene"]      = new[] { "Scene: {0}", "Scena: {0}", "Szene: {0}", "Scène : {0}", "Escena: {0}", "场景：{0}", "Cena: {0}", "Сцена: {0}" },
        ["log_src_scene"]  = new[] { "Scene", "Scena", "Szene", "Scène", "Escena", "场景", "Cena", "Сцена" },
        ["scene_add"]      = new[] { "Add scene", "Dodaj scenę", "Szene hinzufügen", "Ajouter une scène", "Añadir escena", "添加场景", "Adicionar cena", "Добавить сцену" },
        ["scene_add_examples"] = new[] { "Add example scenes", "Dodaj przykładowe sceny", "Beispielszenen hinzufügen", "Ajouter des scènes d'exemple", "Añadir escenas de ejemplo", "添加示例场景", "Adicionar cenas de exemplo", "Добавить примеры сцен" },
        ["scene_run"]      = new[] { "Run", "Uruchom", "Ausführen", "Exécuter", "Ejecutar", "运行", "Executar", "Запустить" },
        ["scene_edit"]     = new[] { "Edit", "Edytuj", "Bearbeiten", "Modifier", "Editar", "编辑", "Editar", "Изменить" },
        ["scene_delete"]   = new[] { "Delete", "Usuń", "Löschen", "Supprimer", "Eliminar", "删除", "Excluir", "Удалить" },
        ["scene_up"]       = new[] { "Move up", "Przesuń w górę", "Nach oben", "Monter", "Subir", "上移", "Mover para cima", "Вверх" },
        ["scene_down"]     = new[] { "Move down", "Przesuń w dół", "Nach unten", "Descendre", "Bajar", "下移", "Mover para baixo", "Вниз" },
        ["scene_del_confirm"] = new[] { "Delete scene \"{0}\"?", "Usunąć scenę \"{0}\"?", "Szene \"{0}\" löschen?", "Supprimer la scène « {0} » ?", "¿Eliminar la escena \"{0}\"?", "删除场景“{0}”？", "Excluir a cena \"{0}\"?", "Удалить сцену \"{0}\"?" },
        ["scene_empty"]    = new[]
        {
        ...
        ["scene_empty_def"] = new[] { "(no changes)", "(bez zmian)", "(keine Änderungen)", "(aucun changement)", "(sin cambios)", "（无更改）", "(sem alterações)", "(без изменений)" },
        ["scene_name"]     = new[] { "Name", "Nazwa", "Name", "Nom", "Nombre", "名称", "Nome", "Название" },
        ["scene_glyph"]    = new[] { "Icon (optional)", "Ikona (opcjonalnie)", "Symbol (optional)", "Icône (facultatif)", "Icono (opcional)", "图标（可选）", "Ícone (opcional)", "Значок (необязательно)" },
        ["scene_hint_unchecked"] = new[]
        {
        ...
        ["sc_profile"]     = new[] { "Profile", "Profil", "Profil", "Profil", "Perfil", "情景模式", "Perfil", "Профиль" },
        ["scene_example_work"]   = new[] { "Work", "Praca", "Arbeit", "Travail", "Trabajo", "办公", "Trabalho", "Работа" },
        ["scene_example_travel"] = new[] { "Travel", "Podróż", "Reise", "Voyage", "Viaje", "出行", "Viagem", "Поездка" },
        ["twa_scenes"]     = new[] { "Switch scenes", "Przełączaj sceny", "Szenen wechseln", "Changer de scène", "Cambiar escenas", "切换场景", "Alternar cenas", "Переключение сцен" },
        ["twa_kbd"]        = new[] { "Keyboard backlight", "Podświetlenie klawiatury", "Tastaturbeleuchtung", "Rétroéclairage du clavier", "Retroiluminación del teclado", "键盘背光", "Retroiluminação do teclado", "Подсветка клавиатуры" },
        // feedback round 2
        ["set_refresh_now"] = new[] { "Current refresh rate", "Aktualne odświeżanie", "Aktuelle Bildwiederholrate", "Taux de rafraîchissement actuel", "Tasa de refresco actual", "当前刷新率", "Taxa de atualização atual", "Текущая частота обновления" },
        ["webcam_block_confirm"] = new[] { "Confirm the block", "Potwierdź blokadę", "Sperre bestätigen", "Confirmer le blocage", "Confirmar el bloqueo", "确认锁定", "Confirmar o bloqueio", "Подтвердить блокировку" },
        ["scene_example_current"] = new[] { "Current setup", "Bieżące ustawienia", "Aktuelles Setup", "Configuration actuelle", "Configuración actual", "当前设置", "Configuração atual", "Текущие настройки" },
        ["set_grp_scen"]   = new[] { "Scenarios tab", "Zakładka Scenariusze", "Szenarien-Tab", "Onglet Scénarios", "Pestaña Escenarios", "场景选项卡", "Aba Cenários", "Вкладка Сценарии" },
        ["set_refresh_set"] = new[] { "Change now", "Zmień teraz", "Jetzt ändern", "Changer maintenant", "Cambiar ahora", "立即更改", "Alterar agora", "Изменить сейчас" },
        ["scene_del_arm"]  = new[] { "Click again to delete", "Kliknij ponownie, aby usunąć", "Zum Löschen erneut klicken", "Cliquez à nouveau pour supprimer", "Haz clic de nuevo para eliminar", "再次点击以删除", "Clique novamente para excluir", "Нажмите ещё раз, чтобы удалить" },
        ["ec_view_title"]  = new[] { "EC live view", "Podgląd EC na żywo", "EC-Live-Ansicht", "Vue EC en direct", "Vista EC en vivo", "EC 实时视图", "Visualização EC ao vivo", "Просмотр EC в реальном времени" },
        ["ec_view_marker"] = new[] { "Marker", "Marker", "Marker", "Marqueur", "Marcador", "标记", "Marcador", "Маркер" },
        ["ec_view_noise"]  = new[] { "Muted (always changing): {0}", "Wyciszone (zmieniają się ciągle): {0}", "Stummgeschaltet (ändern sich ständig): {0}", "Masqués (changent en continu) : {0}", "Silenciados (cambian sin parar): {0}", "已静音（持续变化）：{0}", "Silenciados (mudam o tempo todo): {0}", "Заглушены (меняются постоянно): {0}" },
        ["ec_view_hint"]   = new[]
        {
        ...
        ["set_grp_display"]= new[] { "Display", "Ekran", "Anzeige", "Écran", "Pantalla", "显示", "Tela", "Экран" },
        ["set_sub_home"]   = new[] { "Start", "Start", "Start", "Accueil", "Inicio", "主页", "Início", "Главная" },
        ["set_sub_general"]= new[] { "General", "Ogólne", "Allgemein", "Général", "General", "常规", "Geral", "Общие" },
        ["set_sub_gaming"] = new[] { "Gaming", "Gaming", "Gaming", "Gaming", "Gaming", "游戏", "Gaming", "Игры" },
        ["set_sub_hotkeys"]= new[] { "Hotkeys", "Skróty", "Kürzel", "Raccourcis", "Atajos", "快捷键", "Atalhos", "Клавиши" },
        ["set_sub_system"] = new[] { "System", "System", "System", "Système", "Sistema", "系统", "Sistema", "Система" },
        ["set_tile_general"]= new[] { "Theme, language, colors, app icon", "Motyw, język, kolory, ikona aplikacji", "Design, Sprache, Farben, App-Symbol", "Thème, langue, couleurs, icône", "Tema, idioma, colores, icono", "主题、语言、颜色、图标", "Tema, idioma, cores, ícone", "Тема, язык, цвета, значок" },
        ["set_tile_power"] = new[] { "Charge limit, AC / battery, refresh rate", "Limit ładowania, AC / bateria, odświeżanie", "Ladelimit, Netz / Akku, Bildrate", "Limite de charge, secteur / batterie, Hz", "Límite de carga, CA / batería, Hz", "充电限制、电源/电池、刷新率", "Limite de carga, CA / bateria, Hz", "Лимит заряда, сеть / батарея, герцовка" },
        ["set_tile_notif"] = new[] { "Temperature alert, on-screen messages", "Alert temperatury, komunikaty ekranowe", "Temperaturalarm, Bildschirmmeldungen", "Alerte température, messages à l'écran", "Alerta de temperatura, avisos en pantalla", "温度警报、屏幕提示", "Alerta de temperatura, avisos na tela", "Оповещение о температуре, сообщения" },
        ["set_tile_gaming"]= new[] { "Overlay, metrics, game session report", "Overlay, metryki, raport sesji gry", "Overlay, Metriken, Sitzungsbericht", "Overlay, métriques, rapport de session", "Overlay, métricas, informe de sesión", "悬浮窗、指标、会话报告", "Overlay, métricas, relatório de sessão", "Оверлей, метрики, отчёт сессии" },
        ["set_tile_hotkeys"]= new[] { "Global keyboard shortcuts", "Globalne skróty klawiszowe", "Globale Tastenkürzel", "Raccourcis clavier globaux", "Atajos de teclado globales", "全局快捷键", "Atalhos de teclado globais", "Глобальные горячие клавиши" },
        ["set_tile_system"]= new[] { "Autostart, updates, tray menu, backup", "Autostart, aktualizacje, menu tray, kopia", "Autostart, Updates, Tray-Menü, Backup", "Démarrage auto, mises à jour, sauvegarde", "Inicio automático, actualizaciones, copia", "自启动、更新、托盘菜单、备份", "Início automático, atualizações, backup", "Автозапуск, обновления, резервная копия" },
        ["st2_limit_on"]   = new[] { "Limit {0}%", "Limit {0}%", "Limit {0}%", "Limite {0}%", "Límite {0}%", "限制 {0}%", "Limite {0}%", "Лимит {0}%" },
        ["st2_limit_off"]  = new[] { "Limit off", "Limit wył.", "Limit aus", "Limite désact.", "Límite des.", "限制关", "Limite desl.", "Лимит выкл" },
        ["st2_hz"]         = new[] { "AC {0} Hz / bat. {1} Hz", "AC {0} Hz / bat. {1} Hz", "Netz {0} / Akku {1} Hz", "Secteur {0} / batt. {1} Hz", "CA {0} / bat. {1} Hz", "电源 {0} / 电池 {1} Hz", "CA {0} / bat. {1} Hz", "Сеть {0} / бат. {1} Гц" },
        ["st2_metrics"]    = new[] { "{0} metrics", "{0} metryk", "{0} Metriken", "{0} métriques", "{0} métricas", "{0} 项指标", "{0} métricas", "{0} метрик" },
        ["st2_hotkeys"]    = new[] { "{0} of {1} enabled", "{0} z {1} włączonych", "{0} von {1} aktiv", "{0} sur {1} actifs", "{0} de {1} activos", "已启用 {0}/{1}", "{0} de {1} ativos", "{0} из {1} включено" },
        ["st2_system"]     = new[] { "Autostart {0} · updates {1}", "Autostart {0} · aktualizacje {1}", "Autostart {0} · Updates {1}", "Démarrage {0} · MAJ {1}", "Inicio {0} · actualiz. {1}", "自启动{0} · 更新{1}", "Início {0} · atualiz. {1}", "Автозапуск {0} · обновления {1}" },
        ["st2_whatsnew"]   = new[] { "What's new in v{0}", "Co nowego w v{0}", "Neu in v{0}", "Nouveautés de la v{0}", "Novedades de v{0}", "v{0} 新功能", "Novidades da v{0}", "Что нового в v{0}" },
        ["st2_exp"]        = new[] { "experimental on", "eksperymentalne wł", "Experimentell an", "expérimental act.", "experimental act.", "实验模式开", "experimental lig.", "эксперим. вкл" },
        ["ec_err_unsupported"] = new[] {
