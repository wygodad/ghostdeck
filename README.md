...
📋 **154 MSI models recognised** - **45 models confirmed on real hardware** by their owners (GE78HX/Vector boards, Raider GE78 HX 14VHG, Prestige 14 AI Studio, Prestige 16 Studio / Summit E16 Flip, Katana GF66 12U / Sword 15 A12UC, Stealth 14 Studio A13VF, Raider GE68 HX / Vector 16 HX A13V, Crosshair 15 B12U, Crosshair A16 HX, Crosshair 16 HX AI, Crosshair 17 HX AI, Crosshair 18 HX AI, Sword 16 HX, Sword 17 HX B14VGKG, GE67 HX, GE66 Raider / GP66 Leopard, both Cyborg 15s, Cyborg A15 AI, both GF63 Thins, Raider GE76 12UE/12UGS, GE76 Raider 11U / GP76 Leopard 11UG, Raider A18 HX, Vector A18 HX, Vector 16 HX AI / Raider 16 HX AI, Vector A16 HX A8WIG, Titan 18 HX Dragon, Bravo 15 B7ED, Bravo 17, Katana GF66 11U, Pulse/Katana 17 B13V, Katana 15 HX B14W, Modern 14 C12M, Pulse 16 AI C1V, Pulse 17 AI C1V, Creator M16 / Pulse 15 / Katana 15 B13V / Crosshair 16 A13V, Creator M14 A13VE, Alpha 17 C7VF/C7VG, Thin 15 B12U, Vector 17 HX AI A2XWHG, Summit E14 Flip Evo / Prestige 14 H, Stealth 16 AI+ B3W, Stealth A16 AI+ A3XWHG, Stealth 18 HX AI A2XW), the rest are experimental (opt-in). See the **[full supported-models list](docs/SUPPORTED_MODELS.md)**, or browse it live in the app's **Models** tab.
...
- 🌀 **Fan curve editor** - drag a custom CPU/GPU curve and run it on **Balanced / Extreme / Super Battery** (MSI Center only allows one in Extreme); fully reversible. Speeds go up to **150 %**, the same scale MSI Center's own sliders use - some boards genuinely spin faster above "100 %" (built-in presets stay at or below 100 %; the range above is only ever reached by dragging a slider there yourself). *Silent is the exception:* its power cap lives in the same EC byte the curve needs, so turning a curve on in Silent necessarily leaves Silent for Balanced - the app warns and switches for you. **Single-fan-curve boards** (where MSI Center shows one slider, e.g. Thin GF63 12VE) automatically get a single full-width curve editor, and the unused GPU tables are never written
...
**154 models** are recognised, grouped into EC families using hardware mapping information documented by [msi-ec](https://github.com/BeardOverflow/msi-ec), with fan and temperature register layouts cross-checked against [MControlCenter](https://github.com/dmitry-s93/MControlCenter):

| Tier | Models | EC firmware / registers | Fan curve |
|---|---|---|---|
| ✅ **Tested** | **Alpha 17 C7VF / C7VG**, **Bravo 15 B7ED**, **Bravo 17 C7VE / D7VFK**, **Creator M14 A13VE**, **Creator M16 B13VF / Pulse 15 B13VGK / Katana 15 B13UDXK / Crosshair 16 A13V**, **Crosshair 15 B12UEZ / B12UGSZ**, **Crosshair 16 HX AI D2XW**, **Crosshair 17 HX AI D2XW**, **Crosshair 18 HX AI A2XW**, **Crosshair A16 HX (D7W/D8W)**, **Cyborg 15 A12VF / A13VF**, **Cyborg 15 B13WFKG / B2RWFKG / B2RWEKG**, **Cyborg A15 AI B2HWGKG / B2HWEKG**, **GE66 Raider / GP66 Leopard**, **GE76 Raider 11U / 11UH / GP76 Leopard 11UG**, **GF63 Thin 11UC / 11SC**, **Katana 15 HX B14WEK / B14WFK**, **Katana GF66 11UE / 11UG**, **Katana GF66 12U / Sword 15 A12UC**, **Modern 14 C12M**, **Prestige 14 AI Studio C1UDXG**, **Prestige 16 Studio A13VE / Summit E16 Flip A13VFT**, **Pulse 16 AI C1VGKG/C1VFKG**, **Pulse 17 AI C1VGKG / C1VFKG**, **Pulse/Katana 17 B13V/GK**, **Raider A18 HX A7VIG**, **Raider GE67 HX 12U**, **Raider GE68 HX 14VIG / Vector 16 HX A13V**, **Raider GE76 12UE / 12UGS**, **Raider GE78 HX 14VHG**, **Raider GE78HX 13V / Vector 17 HX A14V**, **Stealth 14 Studio A13VF**, **Stealth 16 AI+ B3WI / B3WH**, **Stealth 18 HX AI A2XW**, **Stealth A16 AI+ A3XWHG**, **Summit E14 Flip Evo A12MT / Prestige 14 H B13U**, **Sword 16 HX B13V / B14V**, **Sword 17 HX B14VGKG**, **Thin 15 B12UCX / B12VE**, **Thin GF63 12VE**, **Titan 18 HX Dragon Edition**, **Vector 16 HX AI / Raider 16 HX AI A2XWHG / A2XWIG**, **Vector 17 HX AI A2XWHG**, **Vector A16 HX A8WIG**, **Vector A18 HX A9WHG / Raider A18 HX A9WIG / A9WJG** | `17KKIMS1.*`, `158PIMS1.*`, `17LNIMS1.*`, `14P1IWS1.*`, `1585EMS1.*`, `1583EMS1.*`, `15P4EMS1.*`, `17T4EMS1.*`, `1841EMS1.*`, `15PLIMS1.*`, `15K1IMS1.*`, `15Q3EMS1.*`, `15QLIMS1.*`, `1543EMS1.*`, `17K3EMS1.*`, `16R6EMS1.*`, `1587EMS1.*`, `1581EMS1.*`, `1584EMS1.*`, `14J1IMS1.*`, `14N2EMS1.*`, `1594EMS1.*`, `15P3EMS1.*`, `17T3EMS1.*`, `17L5EMS1.*`, `182KIMS1.*`, `1545IMS1.*`, `15M1IMS2.*`, `17K4EMS1.*`, `17S1IMS2.*`, `17S1IMS1.*`, `17S2IMS2.*`, `14K1EMS1.*`, `2631EMS1.*`, `1833EMS1.*`, `15FLIMS1.*`, `14F1EMS1.*`, `15P2EMS1.*`, `17T2EMS1.*`, `16R8IMS2.*`, `16R8IMS1.*`, `1824EMS1.*`, `15M3EMS1.*`, `17S3EMS1.*`, `15MMIMS1.*`, `182LIMS1.*` - shift `0xD2` / fan `0xD4` | ✅ editable |
| ⚗️ **G2 family** (74) | Raider / Vector / Titan HX (13V–14V), Stealth 16-18, Sword / Pulse / Crosshair 16, Katana, Cyborg, Bravo, Modern / Prestige / Summit | shift `0xD2` / fan `0xD4` / super-batt `0xEB` | ◉ editable after opt-in (unverified) |
| ⚗️ **G1 family** (35) | older GS / GF / GE / GP, Modern, Alpha, Bravo, Delta, Creator | shift `0xF2` / fan `0xF4` / charge `0xEF` | - profiles only |

The G2 fan-curve tables use the fixed addresses (CPU `0x6A`/`0x72`, GPU `0x82`/`0x8A`) that MControlCenter writes across the whole family; on experimental models the curve is editable once you opt in, but stays flagged **unverified** until you compare it with MSI Center on your own model. See the **[full per-firmware list of all 154 models](docs/SUPPORTED_MODELS.md)** (source of truth: [`Devices.cs`](Core/Devices.cs)). A handful of models whose msi-ec config documents no "Silent" fan value are deliberately left out (Silent is this app's core function - guessing it would be unsafe).
