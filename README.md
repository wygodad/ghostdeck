...
**149 models** are recognised, grouped into EC families using hardware mapping information documented by [msi-ec](https://github.com/BeardOverflow/msi-ec), with fan and temperature register layouts cross-checked against [MControlCenter](https://github.com/dmitry-s93/MControlCenter):

| Tier | Models | EC firmware / registers | Fan curve |
|---|---|---|---|
| ✅ **Tested** | **Alpha 17 C7VF / C7VG**, **Bravo 15 B7ED**, **Bravo 17 C7VE / D7VFK**, **Creator M14 A13VE**, **Creator M16 B13VF / Pulse 15 B13VGK / Katana 15 B13UDXK**, **Crosshair 15 B12UEZ / B12UGSZ**, **Crosshair 16 HX AI D2XW**, **Crosshair 17 HX AI D2XW**, **Crosshair A16 HX (D7W/D8W)**, **Cyborg 15 A12VF / A13VF**, **Cyborg 15 B13WFKG / B2RWFKG / B2RWEKG**, **GE66 Raider / GP66 Leopard**, **GF63 Thin 11UC / 11SC**, **Katana 15 HX B14WEK**, **Katana GF66 11UE / 11UG**, **Katana GF66 12U / Sword 15 A12UC**, **Modern 14 C12M**, **Prestige 16 Studio A13VE / Summit E16 Flip A13VFT**, **Pulse 16 AI C1VGKG/C1VFKG**, **Pulse/Katana 17 B13V/GK**, **Raider A18 HX A7VIG**, **Raider GE67 HX 12U**, **Raider GE68 HX 14VIG / Vector 16 HX A13V**, **Raider GE76 12UE / 12UGS**, **Raider GE78 HX 14VHG**, **Raider GE78HX 13V / Vector 17 HX A14V**, **Stealth 14 Studio A13VF**, **Sword 16 HX B13V / B14V**, **Sword 17 HX B14VGKG**, **Thin GF63 12VE**, **Titan 18 HX Dragon Edition**, **Vector 16 HX AI / Raider 16 HX AI A2XWHG / A2XWIG**, **Vector A16 HX A8WIG**, **Vector A18 HX A9WHG** | `17KKIMS1.*`, `158PIMS1.*`, `17LNIMS1.*`, `14P1IWS1.*`, `1585EMS1.*`, `1583EMS1.*`, `15P4EMS1.*`, `17T4EMS1.*`, `15PLIMS1.*`, `15K1IMS1.*`, `15Q3EMS1.*`, `1543EMS1.*`, `16R6EMS1.*`, `1587EMS1.*`, `1581EMS1.*`, `1584EMS1.*`, `14J1IMS1.*`, `1594EMS1.*`, `15P3EMS1.*`, `17L5EMS1.*`, `182KIMS1.*`, `1545IMS1.*`, `15M1IMS2.*`, `17K4EMS1.*`, `17S1IMS2.*`, `17S1IMS1.*`, `17S2IMS2.*`, `14K1EMS1.*`, `15P2EMS1.*`, `17T2EMS1.*`, `16R8IMS1.*`, `1824EMS1.*`, `15M3EMS1.*`, `15MMIMS1.*`, `182LIMS1.*` - shift `0xD2` / fan `0xD4` | ✅ editable |
...
The G2 fan-curve tables use the fixed addresses (CPU `0x6A`/`0x72`, GPU `0x82`/`0x8A`) that MControlCenter writes across the whole family; on experimental models the curve is editable once you opt in, but stays flagged **unverified** until you compare it with MSI Center on your own model. The Alpha 17 C7VF/C7VG is now an exception backed by the owner's #152 capture: its CPU/GPU speed tables are confirmed at `0x72`/`0x8A`; the same owner's #151 capture found `0xEB=0x00` in every scenario, so GhostDeck leaves that generic G2 Super Battery register untouched on this model. See the **[full per-firmware list of all 149 models](docs/SUPPORTED_MODELS.md)** (source of truth: [`Devices.cs`](Core/Devices.cs)). A handful of models whose msi-ec config documents no "Silent" fan value are deliberately left out (Silent is this app's core function - guessing it would be unsafe).
