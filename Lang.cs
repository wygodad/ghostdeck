...
public static class Lang
{
    ...
    private static readonly Dictionary<string, string[]> Map = new()
    {
        ...
        ["st_matrix_note"] = new[] {
            "0x34 = Extreme power unlock: 00 only in Extreme, 01 in the other profiles. Silent vs Balanced is decided solely by the fan byte 0xD4 (1D = Silent).",
            "0x34 = odblokowanie mocy Extreme: 00 tylko w Extreme, 01 w pozostałych profilach. O Silent vs Balanced decyduje wyłącznie bajt wentylatora 0xD4 (1D = Silent).",
            "0x34 = Extreme-Leistungsfreigabe: 00 nur in Extreme, sonst 01. Silent vs Balanced entscheidet allein das Lüfterbyte 0xD4 (1D = Silent).",
            "0x34 = déblocage puissance Extreme : 00 seulement en Extreme, 01 ailleurs. Silent vs Balanced dépend uniquement de l'octet ventilateur 0xD4 (1D = Silent).",
            "0x34 = desbloqueo de potencia Extreme: 00 solo en Extreme, 01 en el resto. Silent vs Balanced lo decide solo el byte del ventilador 0xD4 (1D = Silent).",
            "0x34 = Extreme 功耗解锁：仅 Extreme 为 00，其余为 01。Silent 与 Balanced 仅由风扇字节 0xD4 区分（1D = Silent）。",
            "0x34 = desbloqueio de potência Extreme: 00 só no Extreme, 01 nos outros. Silent vs Balanced é decidido só pelo byte da ventoinha 0xD4 (1D = Silent).",
            "0x34 = разблокировка мощности Extreme: 00 только в Extreme, 01 в остальных. Silent и Balanced различает только байт вентилятора 0xD4 (1D = Silent)." },
        ["fc_silent_warn"] = new[] {
